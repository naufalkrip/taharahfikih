    ...
    <div className="space-y-10">
      ...
      <RujukanSection
        rujukan={[
          ...
          { title: "Shahih Al-Bukhari", sumber: "Kitab Al-Wudhu', No. 174-180", keterangan: "Hadits tentang air yang terkena najis dan cara mensucikannya.", arabic: "إِذَا وُقِعَ فِي الْإِنَاءِ الذُّبَابُ فَإِنَّ فِي أَحَدِ جَنَاحَيْهِ دَاءً وَفِي الْآخَرِ شِفَاءً", translation: "Jika seekor lalat jatuh ke dalam bejana kalian, maka sesungguhnya pada salah satu sayapnya terdapat penyakit dan pada sayap lainnya terdapat obat. (HR. Bukhari)" },
          { title: "Shahih Muslim", sumber: "Kitab Ath-Thaharah, No. 545-567", keterangan: "Hadits tentang najis anjing dan cara mensucikan (7x + tanah).", arabic: "طَهُورُ إِنَاءِ أَحَدِكُمْ إِذَا وَلَغَ فِيهِ الْكَلْبُ أَنْ يَغْسِلَهُ سَبْعَ مَرَّاتٍ أُولَاهُنَّ بِالتُّرَابِ", translation: "Cara menyucikan bejana salah seorang di antara kalian yang dijilat anjing adalah dengan mencucinya tujuh kali, yang pertama dengan tanah. (HR. Muslim)" },
          { title: "Sunan Abu Dawud", sumber: "Kitab Ath-Thaharah, No. 33-41", keterangan: "Hadits tentang najis mukhaffafah (kencing bayi) dan cara membersihkannya.", arabic: "يُغْسَلُ مِنْ بَوْلِ الْجَارِيَةِ وَيُرَشُّ مِنْ بَوْلِ الْغُلَامِ", translation: "Air kencing bayi perempuan dicuci, sedangkan air kencing bayi laki-laki cukup diperciki air. (HR. Abu Dawud)" },
          { title: "Sunan An-Nasa'i", sumber: "Kitab Ath-Thaharah, No. 293-305", keterangan: "Hadits tentang jenis-jenis najis dan tata cara bersuci.", arabic: "إِنَّ بَنِي إِسْرَائِيلَ كَانُوا إِذَا أَصَابَ أَحَدَهُمْ قَطْرَةُ بَوْلٍ قَرَضُوا بِالْمَقَارِيضِ", translation: "Dahulu Bani Israil apabila salah seorang mereka terkena percikan air kencing, mereka memotong (pakaian)nya dengan gunting. (HR. Nasa'i)" },
