...
export function QuizPlayer() {
  ...
  const info = isTopicValid
    ? isAll
      ? { title: "Semua Materi", color: "purple" as const }
      : topicInfo[topic]
    : null;
    ...
    return (
      <div className="min-h-screen bg-background flex items-center justify-center">
        <div className="text-center space-y-4">
          <p className="text-muted-foreground">Topik quiz tidak ditemukan</p>
          <Link
            to="/quiz"
  ...
  if (questions.length === 0) {
    return (
      <div className="min-h-screen bg-background flex items-center justify-center">
        <div className="text-center space-y-4">
          <p className="text-muted-foreground">Belum ada pertanyaan untuk topik ini</p>
          <Link
            to="/quiz"
            className="inline-flex items-center gap-2 px-4 py-2 rounded-xl bg-primary text-primary-foreground text-sm font-medium"
          >
              ...
              <div className="flex items-center gap-3 mb-4">
                ...
                <div>
                  ...
                  <p className="text-xs text-muted-foreground mt-0.5">
                    Progress quiz akan hilang jika Anda keluar sekarang.
                  </p>
                </div>
              </div>
