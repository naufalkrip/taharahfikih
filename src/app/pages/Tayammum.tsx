...
export function Tayammum() {
  ...
  return (
    <div className="space-y-10">
      ...
      <RujukanSection
        rujukan={[
          { title: "Al-Qur'an Al-Karim", sumber: "QS. Al-Maidah: 6", keterangan: "Ayat utama tentang tayammum sebagai pengganti wudhu dan mandi." },
          { title: "Shahih Al-Bukhari", sumber: "Kitab At-Tayammum, No. 334-368", keterangan: "Hadits-hadits tentang tayammum, syarat dan tata caranya." },
          { title: "Shahih Muslim", sumber: "Kitab Al-Haidh, No. 717-735", keterangan: "Hadits tentang tayammum dan hal-hal yang membatalkannya." },
          { title: "Sunan Abu Dawud", sumber: "Kitab Ath-Thaharah, No. 316-340", keterangan: "Hadits tentang media tayammum dan tata caranya." },
